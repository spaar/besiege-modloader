...
namespace spaar.ModLoader
{
  ...
  public class Game : SingleInstance<Game>
  {
    ...
    private static Zone barrenExpanse = new Zone(-1, 12, "Barren Expanse",
      Island.Sandbox);
    private static Zone oldSandbox = new Zone(-2, 13, "Old Sandbox",
      Island.Sandbox);
    private static Zone[] zones = {
      new Zone(0, 14, "Sandbox", Island.Sandbox),

      new Zone(1, 15, "Southern Cottage", Island.Ipsilon),
      new Zone(2, 16, "Mill", Island.Ipsilon),
      new Zone(3, 17, "Old Howl Battlefield", Island.Ipsilon),
      new Zone(4, 18, "Perimeter Wall", Island.Ipsilon),
      new Zone(5, 19, "The Queen's Fodder", Island.Ipsilon),
      new Zone(6, 20, "Old Mining Site", Island.Ipsilon),
      new Zone(7, 21, "Standing Stone", Island.Ipsilon),
      new Zone(8, 22, "Thinside Fort", Island.Ipsilon),
      new Zone(9, 23, "Midlands Encampment", Island.Ipsilon),
      new Zone(10, 24, "Lyre Peak", Island.Ipsilon),
      new Zone(11, 25, "Highland Tower", Island.Ipsilon),
      new Zone(12, 26, "Pine Lumber Site", Island.Ipsilon),
      new Zone(13, 27, "Solomon's Flock", Island.Ipsilon),
      new Zone(14, 28, "Marksman's Pass", Island.Ipsilon),
      new Zone(15, 29, "Wynnfrith's Keep", Island.Ipsilon),

      new Zone(16, 30, "The Duke's Plea", Island.Tolbrynd),
      new Zone(17, 31, "Southern Shrine", Island.Tolbrynd),
      new Zone(18, 32, "Scouts of Tolbrynd", Island.Tolbrynd),
      new Zone(19, 33, "The Duke's Prototypes", Island.Tolbrynd),
      new Zone(20, 34, "The Duke's Dear Freighers", Island.Tolbrynd),
      new Zone(21, 35, "Grand Crystal", Island.Tolbrynd),
      new Zone(22, 36, "Farmer Gascoigne", Island.Tolbrynd),
      new Zone(23, 37, "Village of Diom", Island.Tolbrynd),
      new Zone(24, 38, "Midland Patrol", Island.Tolbrynd),
      new Zone(25, 39, "Valley of the Wind", Island.Tolbrynd),
      new Zone(26, 40, "Odd Contraption", Island.Tolbrynd),
      new Zone(27, 41, "Diom Well", Island.Tolbrynd),
      new Zone(28, 42, "Surrounded", Island.Tolbrynd),
      new Zone(29, 36, "Sacred Flame", Island.Tolbrynd),
      new Zone(30, 44, "Argus' Grounds", Island.Tolbrynd),
      new Zone(31, 45, "The Duke's Knowledge", Island.Tolbrynd),
      new Zone(32, 46, "The Venerated Heart", Island.Tolbrynd),
      new Zone(33, 47, "Shattered Field", Island.Tolbrynd),
      new Zone(34, 5, "Aras' Refuge", Island.Tolbrynd),

      new Zone(35, 6, "The Frozen Path", Island.Valfross),
      new Zone(36, 7, "The Awakening Bells", Island.Valfross),
      new Zone(37, 8, "Peculiar Clearing", Island.Valfross),
      new Zone(38, 9, "The Martyr Knights", Island.Valfross),
      new Zone(39, 10, "Ordyce Lode", Island.Valfross),
      new Zone(40, 11, "Penitent Tower", Island.Valfross), 
    };
